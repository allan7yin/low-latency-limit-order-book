...
bool Order::getBuyOrSell() const { return buyOrSell; }

int Order::getShares() const { return shares; }

int Order::getLimit() const { return limit; }

int Order::getEntryTime() const { return entryTime; }

int Order::getEventTime() const { return eventTime; }

Limit *Order::getParentLimit() const { return parentLimit; }
